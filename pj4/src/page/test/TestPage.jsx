...
const TestPetPage = () => {
    ...
    const handleOptionClick = (selectedOptionId) => {
        ...
        if (currentIndex === questionData.length - 1) {
            navigate(`/test/result.do?tab=${tab}`, { state: { answers: newAnswers, testQuestiontype: tab } });
        } else {
    ...
    return (
        <>
            <Box sx={{backgroundColor,height:'100%', width: "100%", mx: "auto"}} className='test-container'>
