                ...
                {result && (
                    <>
                        ...
                        sx={{
                            ...
                            letterSpacing:'1px',
                            color:'#5E350A',
                        }}>{result.testResultName}</Typography>
                        {result.postFile?.postFileId && (
                            
                            <img src={`${process.env.REACT_APP_API_BASE_URL}/file/imgDown.do?fileId=${result.postFile.postFileId}`}
                                style={{
                                    width: '240px',
                                    height: '240px',
                                    objectFit: 'cover',
                        ...
                        <Typography className="result-content"
                            sx={{marginY:'20px', fontWeight:'600'}}>{result.testResultContent}</Typography>
                        </Box>
                        <Typography className="result-recommend">추천: {result.testResultRecommend}</Typography>
