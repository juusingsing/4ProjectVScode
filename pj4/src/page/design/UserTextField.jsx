  ...
  return (
    <TextField
      ...
      InputProps={{
        ...
        sx: {
          backgroundColor: 'rgba(66, 59, 59, 0)', // 입력 필드 배경색
          borderRadius: '4px 4px 0 0', // 상단만 둥근 모서리 (filled variant 기본)
          border: 'none',
          outline: 'none',
          '&:hover': {
            backgroundColor: 'rgba(34, 29, 29, 0.23)', // 호버 시 배경색 변경
          },
          '&.Mui-focused': {
            backgroundColor: 'rgba(34, 29, 29, 0.23)', // 포커스 시 배경색 변경
          ...
          '& input:-webkit-autofill': {
            boxShadow: 'inset 0 0 0 1000px rgba(34, 29, 29, 1) !important',
            WebkitBoxShadow: 'inset 0 0 0 1000px rgba(34, 29, 29, 0) !important',
            WebkitTextFillColor: 'white !important',
            transition: 'background-color 5000s ease-in-out 0s', // Chrome 자동완성 배경색 트릭
          },
